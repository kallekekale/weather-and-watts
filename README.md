...
> **Status: early development** — FMI weather ingestion is working. Everything else is in progress or planned. The architecture and scope reflect the current direction, but may change as the project goes on.
